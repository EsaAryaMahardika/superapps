        ...
        <nav class="flex-1 overflow-y-auto py-4 pl-4">
            <ul class="sidebar-menu list-none p-0 m-0">
                <li class="{{ Request::is('kantor') ? 'active' : '' }}">
                    <a href="/kantor"><i class="fa fa-home"></i><span>Dashboard</span></a>
                </li>
                <li class="{{ Request::is('kantor/boyong*') ? 'active' : '' }}">
                    <a href="/kantor/boyong"><i class="fa fa-person-walking-arrow-right"></i><span>Boyong</span></a>
                </li>
                <li class="{{ Request::is('kantor/syahriah*') ? 'active' : '' }}">
        ...
        <header class="h-20 bg-white/50 backdrop-blur-xl flex items-center justify-between px-6 md:px-8 sticky top-0 z-40 border-b border-gray-100/50">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <h1 class="text-sm md:text-xl font-bold text-[#1B2559]">{{ Auth::user()->username }}</h1>
                </div>
            </div>
        </header>
