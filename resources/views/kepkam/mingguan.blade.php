    ...
    <div class="fixed inset-0 z-50 hidden items-center justify-center p-4" id="add">
        ...
        <div class="relative bg-white rounded-[20px] shadow-2xl w-full max-w-2xl z-10 max-h-[90vh] overflow-y-auto">
            <div class="border-b border-gray-100 p-6 flex items-center justify-between">
                <h5 class="text-xl font-bold text-[#1B2559]">Buat Absensi Mingguan</h5>
                    ...
                    <form action="/kepkam/mingguan" method="post" id="formMingguan">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <div class="relative">
                                    <select class="w-full bg-gray-50 border border-gray-200 text-[#2B3674] text-sm rounded-lg focus:ring-[#4318FF] focus:border-[#4318FF] block p-2.5 pr-8 appearance-none outline-none"
